<?php
	...
	*/
	...
	/* Do not remove: CustomTextDesignModulePage */
	class CustomTextDesignDesign12ModuleFrontController extends ModuleFrontController{
    	...
    	*/
		...
		public function initContent()
		{
			...
			$pageconfig = $this->module->getModulePage($pagename);

			$id_page_config = $pageconfig['id_page_config'];
			$cfg = $this->module->getConfigKeys($id_page_config);
			...
			$this->context->smarty->assign(array(
				...
				'path' => $this->module->l('Customized Product'),
